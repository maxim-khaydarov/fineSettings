...
public class ActivityAppsSkype extends ListActivity{
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
        	app_save_skype = app.packageName;
   	      Intent intent = new Intent(this, ActivityiCloud.class);
            	 startActivity(intent);
            	      	overridePendingTransition(center_to_right, center_to_right2);
            	      	 
        } catch (ActivityNotFoundException e) {
            Toast.makeText(ActivityAppsSkype.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsSkype.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsSkype.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_SKYPE, app_save_skype);
	   	editor.apply();
	   }
