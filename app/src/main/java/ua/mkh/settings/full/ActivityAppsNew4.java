...
public class ActivityAppsNew4 extends ListActivity{
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            ...
            Toast.makeText(ActivityAppsNew4.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsNew4.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsNew4.this, null,
                    "Загрузка приложений...");
            super.onPreExecute();
        }
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_NEW4, app_save_new4);
	   	editor.apply();
	   }
