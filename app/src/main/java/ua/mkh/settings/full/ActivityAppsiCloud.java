...
public class ActivityAppsiCloud extends ListActivity{
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
        	app_save_icloud = app.packageName;
   	      Intent intent = new Intent(this, SettingsActivity.class);
            	 startActivity(intent);
            	 overridePendingTransition(center_to_right, center_to_right2);
            	      	 
            	 } catch (ActivityNotFoundException e) {
            Toast.makeText(ActivityAppsiCloud.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsiCloud.this,
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_ICLOUD, app_save_icloud);
	   	editor.apply();
	   }
