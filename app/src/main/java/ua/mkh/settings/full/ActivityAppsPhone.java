...
public class ActivityAppsPhone extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_PHONE, app_save_phone);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_phone = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsPhone.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsPhone.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsPhone.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
