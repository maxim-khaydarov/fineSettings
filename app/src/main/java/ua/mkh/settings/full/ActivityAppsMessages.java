...
public class ActivityAppsMessages extends ListActivity {
    ...
    public static final String APP_PREFERENCES = "mysettings"; 
	   ...
	   private String app_save_messages;
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_MESSAGES, app_save_messages);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_messages = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsMessages.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsMessages.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsMessages.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
