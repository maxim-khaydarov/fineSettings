...
public class ActivityAppsMusic extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_MUSIC, app_save_mail);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            ...
            Toast.makeText(ActivityAppsMusic.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsMusic.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsMusic.this, null,
                    "Загрузка приложений...");
            super.onPreExecute();
        }
