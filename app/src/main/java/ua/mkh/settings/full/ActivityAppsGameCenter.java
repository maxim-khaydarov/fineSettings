...
public class ActivityAppsGameCenter extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_GAMECENTER, app_save_gamecenter);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_gamecenter = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsGameCenter.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsGameCenter.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsGameCenter.this, null,
                    "Загрузка приложений...");
            super.onPreExecute();
        }
