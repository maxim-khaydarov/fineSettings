...
public class ActivityAppsNotifications extends ListActivity {
    ...
    protected void onResume() {
	   ...
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_NOTIFICATIONS, app_save_notifications);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_notifications = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsNotifications.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsNotifications.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsNotifications.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
