...
public class ActivityAppsNew2 extends ListActivity{
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            ...
            Toast.makeText(ActivityAppsNew2.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsNew2.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsNew2.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_NEW2, app_save_new2);
	   	editor.apply();
	   }
