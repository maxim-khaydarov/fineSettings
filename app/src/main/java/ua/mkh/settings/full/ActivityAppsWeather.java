...
public class ActivityAppsWeather extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_WEATHER, app_save_weather);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_weather = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsWeather.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsWeather.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsWeather.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
