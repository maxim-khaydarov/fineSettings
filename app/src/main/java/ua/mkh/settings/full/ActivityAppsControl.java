...
public class ActivityAppsControl extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_CONTROL, app_save_control);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_control = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsControl.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsControl.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsControl.this, null,
                    "Загрузка приложений...");
            super.onPreExecute();
        }
