...
public class ActivityAppsSafari extends ListActivity {
    ...
    @Override
	   protected void onPause() {
	   	...
	   	editor.putString(APP_PREFERENCES_SAFARI, app_save_safari);
	   	editor.apply();
	   }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        app_save_safari = app.packageName;
        ...
        try {
            ...
            Toast.makeText(ActivityAppsSafari.this, e.getMessage(),
    ...
    private class LoadApplications extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            listadaptor = new ApplicationAdapter(ActivityAppsSafari.this,
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ActivityAppsSafari.this, null,
                    "�������� ����������...");
            super.onPreExecute();
        }
